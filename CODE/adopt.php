...
<head>
    ...
    <style>
        ...
        /* ===== STYLES FOR ADOPTION MODAL ===== */
        .form-input-container {
            position: relative;
        }
        .form-input-container .form-icon {
            position: absolute; left: 0.875rem; top: 50%; transform: translateY(-50%); color: #9ca3af;
        }
        .form-input-container .form-input { padding-left: 2.5rem; }
        ...
        .custom-checkbox:checked ~ .fa-check { opacity: 1; }
        ...
        .progress-step.active { background-color: #4f46e5; color: white; border-color: #4f46e5; }
        .progress-step.completed { background-color: #34d399; color: white; border-color: #34d399; }
        .progress-step.completed .step-number:before { content: '\f00c'; font-family: 'Font Awesome 7 Free'; font-weight: 900; }
...
<body class="bg-white">
    ...
    <section class="flex flex-col items-center text-center px-4 py-10 ">
        <section class="flex justify-center space-x-4 mb-10  rounded-3xl shadow-2xl bg-gray-200">
            <button id="tab-pets" class="px-6 py-2 border-2 rounded-3xl border-primary-dark font-semibold text-black text-primary-dark hover:bg-gray-300 hover:rounded-3xl"><i class="fa-solid fa-heart text-black"></i>Available Pets</button>
            <button id="tab-donate" class="px-6 py-2 border-2 border-transparent rounded-3xl font-semibold text-black hover:bg-gray-300 hover:rounded-3xl"><i class="fa-solid fa-house text-black"></i>Donate a Pet</button>
        </section>
    </section>

    <div id="pets-section" class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                <div class="relative">
                    <img class="pet-image w-full h-80 bg-gray-200" src="img/A_2.png" alt="Max the Golden Retriever">
                    <span class="absolute top-3 left-3 bg-gray-900/60 text-white text-xs font-semibold px-2 py-0.5 rounded-full">DOG</span>
                    <span class="absolute top-3 right-3 text-white text-2xl cursor-pointer heart-icon"></span>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-900">Max</h3>
                    <p class="text-sm text-gray-500 mb-2">Golden Retriever</p>
                    <div class="flex space-x-4 text-xs font-semibold text-gray-600 mb-3">
                        <span>male</span><span>&bull;</span><span>2 years</span><span>&bull;</span><span>large</span>
                    </div>
                    <p class="max-w-full text-sm text-gray-600 mb-4 max-h-32 overflow-auto">Max is a friendly and energetic Golden Retriever who loves to play fetch and go on long walks. He's great with kids and other dogs.</p>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                <div class="relative">
                    <img class="pet-image w-full h-80 bg-gray-200" src="img/A1.png" alt="Luna the Cat">
                    <span class="absolute top-3 left-3 bg-gray-900/60 text-white text-xs font-semibold px-2 py-0.5 rounded-full">CAT</span>
                    <span class="absolute top-3 right-3 text-white text-2xl cursor-pointer heart-icon"></span>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-900">Luna</h3>
                    <p class="text-sm text-gray-500 mb-2">Short Hair</p>
                    <div class="flex space-x-4 text-xs font-semibold text-gray-600 mb-3">
                        <span>female</span><span>&bull;</span><span>2 years</span><span>&bull;</span><span>large</span>
                    </div>
                    <p class="max-w-full text-sm text-gray-600 mb-4 max-h-32 overflow-auto">Luna is a friendly and energetic Golden Retriever who loves to play fetch and go on long walks. He's great with kids and other dogs.</p>
                    <div class="flex justify-between items-center mb-4 text-sm">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                <div class="relative">
                    <img class="pet-image w-full h-80 bg-gray-200" src="img/A_3.png" alt="Snow the Rabbit">
                    <span class="absolute top-3 left-3 bg-gray-900/60 text-white text-xs font-semibold px-2 py-0.5 rounded-full">RABBIT</span>
                    <span class="absolute top-3 right-3 text-white text-2xl cursor-pointer heart-icon"></span>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-900">Snow</h3>
                    <p class="text-sm text-gray-500 mb-2">Rabbit</p>
                    <div class="flex space-x-4 text-xs font-semibold text-gray-600 mb-3">
                        <span>male</span><span>&bull;</span><span>2 years</span><span>&bull;</span><span>large</span>
                    </div>
                    <p class="max-w-full text-sm text-gray-600 mb-4 max-h-32 overflow-auto">Snow is a friendly and energetic Golden Retriever who loves to play fetch and go on long walks. He's great with kids and other dogs.</p>
                    <div class="flex justify-between items-center mb-4 text-sm">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                <div class="relative">
                    <img class="pet-image w-full h-80 bg-gray-200" src="img/jack.png" alt="Jack the Budgie">
                    <span class="absolute top-3 left-3 bg-gray-900/60 text-white text-xs font-semibold px-2 py-0.5 rounded-full">BIRD</span>
                    <span class="absolute top-3 right-3 text-white text-2xl cursor-pointer heart-icon"></span>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-900">Jack</h3>
                    <p class="text-sm text-gray-500 mb-2">Budgerigar</p>
                    <div class="flex space-x-4 text-xs font-semibold text-gray-600 mb-3">
                        <span>male</span><span>&bull;</span><span>4 months</span><span>&bull;</span><span>small</span>
                    </div>
                    <p class="max-w-full text-sm text-gray-600 mb-4 max-h-32 overflow-auto">Jack is a friendly and energetic budgie who loves to chirp and interact. He's great with people.</p>
                    <div class="flex justify-between items-center mb-4 text-sm">
    ...
    <div id="donate-section" class="max-w-4xl mx-auto bg-white shadow-xl rounded-lg p-6 sm:p-10 hidden border border-gray-200 mb-16">
        <header class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Help a Pet Find a New Home</h1>
            <p class="text-gray-500 mt-2">Follow these simple steps to list your pet for adoption safely.</p>
        </header>

        <div class="relative mb-8">
            <div class="progress-bar-bg h-1 w-full rounded-full"></div>
            <div id="progress-bar" class="progress-bar-fill h-1 absolute top-0 left-0 rounded-full" style="width: 16.66%;"></div>
            <div class="absolute w-full -top-3 flex justify-between">
                <div id="step-1-indicator" class="progress-step active w-8 h-8 rounded-full bg-white border-2 border-indigo-600 flex items-center justify-center">
                    <span class="step-number text-indigo-600 font-bold">1</span>
                </div>
                <div id="step-2-indicator" class="progress-step w-8 h-8 rounded-full bg-white border-2 border-gray-300 flex items-center justify-center">
                    <span class="step-number text-gray-400 font-bold">2</span>
                </div>
                <div id="step-3-indicator" class="progress-step w-8 h-8 rounded-full bg-white border-2 border-gray-300 flex items-center justify-center">
                    <span class="step-number text-gray-400 font-bold">3</span>
                </div>
            </div>
        </div>
        ...
        <form id="donate-form" action="handle_donate_pet.php" method="POST" enctype="multipart/form-data">
            <div id="form-step-1" class="form-step active">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Upload a clear photo</label>
                        <label for="pet-photo-upload" class="cursor-pointer">
                            <div id="image-preview-container" class="relative mt-1 flex justify-center items-center h-64 px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md bg-gray-50 text-gray-400 hover:border-indigo-500 transition-colors">
                ...
                <div class="mt-8 flex justify-end">
                    <button type="button" class="next-step-btn bg-indigo-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-indigo-700 transition-colors">Next: Your Details &rarr;</button>
                </div>
            </div>
            ...
            <div id="form-step-2" class="form-step">
                ...
                <div class="mt-8 flex justify-between">
                    <button type="button" class="prev-step-btn bg-gray-200 text-gray-800 px-6 py-2 rounded-lg font-semibold hover:bg-gray-300 transition-colors">&larr; Back</button>
                    <button type="button" class="next-step-btn bg-indigo-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-indigo-700 transition-colors">Next: Review &rarr;</button>
                </div>
            </div>

            <div id="form-step-3" class="form-step">
                <h2 class="text-xl font-semibold text-gray-900 mb-6 text-center">Step 3: Review & Submit</h2>
                <div class="bg-gray-50 p-6 rounded-lg border">
                    <h3 class="font-bold text-lg mb-4">Please confirm the details:</h3>
                    <dl id="review-details" class="space-y-2"></dl>
                </div>
                ...
                <div class="mt-8 flex justify-between">
                    <button type="button" class="prev-step-btn bg-gray-200 text-gray-800 px-6 py-2 rounded-lg font-semibold hover:bg-gray-300 transition-colors">&larr; Back</button>
                    <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700 transition-colors">Submit Pet for Adoption</button>
                </div>
            </div>
        </form>
    ...
    <div id="adoption-modal" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50 hidden transition-opacity duration-300">
        <div class="modal-content bg-gray-50 rounded-xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto relative transform opacity-100 scale-100">
            <div class="flex justify-between items-center p-5 border-b border-gray-200 sticky top-0 bg-gray-50 z-10">
    ...
    <script>
        ...
        petsTab.addEventListener('click', () => {
            petsTab.classList.add('border-primary-dark', 'text-primary-dark', 'bg-blue-400');
            petsTab.classList.remove('border-transparent', 'text-gray-500');
            donateTab.classList.remove('border-primary-dark', 'text-primary-dark', 'bg-blue-400');
            donateTab.classList.add('border-transparent', 'text-gray-500');
            petsSection.classList.remove('hidden');
            donateSection.classList.add('hidden');
        });

        donateTab.addEventListener('click', () => {
            donateTab.classList.add('border-primary-dark', 'text-primary-dark', 'bg-blue-400');
            donateTab.classList.remove('border-transparent', 'text-gray-500');
            petsTab.classList.remove('border-primary-dark', 'text-primary-dark', 'bg-blue-400');
            petsTab.classList.add('border-transparent', 'text-gray-500');
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const quitModalBtn = document.getElementById('quit-modal-btn');
...
shareLocationBtn.addEventListener('click', () => {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const photoUpload = document.getElementById('pet-photo-upload');
